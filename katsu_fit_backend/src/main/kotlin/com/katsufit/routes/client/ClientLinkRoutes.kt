            ...
            try {
                ...
                val newLinkId = transaction {
                    ClientProfessionalLinks.insert {
                        ...
                        it[professionalId] = professionalUuid.value
                        it[professionalType] = request.professionalType
                        it[invitedBy] = "CLIENT"
                        it[status] = "PENDING"
                        it[invitationMessage] = request.message
        ...
        post("/api/professional/clients/invite") {
            try {
                ...
                val newLinkId = transaction {
                    ClientProfessionalLinks.insert {
                        it[clientId] = clientUuid
                        it[professionalId] = profUuid
                        it[professionalType] = profType
                        it[invitedBy] = "PROFESSIONAL"
                        it[status] = "PENDING"
                        it[invitationMessage] = request.message
                    } get ClientProfessionalLinks.id
                }
